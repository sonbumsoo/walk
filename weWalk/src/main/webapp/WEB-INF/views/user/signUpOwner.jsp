...
<script>
	...
	// 중복 확인을 한 아이디가 아닐시 다시 중복확인을 위한 아이디 저장용 변
	var originId = "";
...
<body>
	...
	<div id="signUser">
		...
		<form name="signUserForm" id="signUserForm" action="signUser" method="post">
			<input type="hidden" name="memberTypeCd" value="002">
			...
			<input type="button" class="btn "
				style="margin-left: 170px; height: 35px; width: 100px;"
				onclick="signUser()" value="가입하기">
		</form>
