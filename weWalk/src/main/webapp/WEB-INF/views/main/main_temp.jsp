		...
		<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
			...
			<li class="nav-item active">
				<p class="nav-link" href="#">
					<i class="fas fa-fw fa-tachometer-alt"></i> <span>${sessionScope.loginID}
						님 환영합니다!</span>
				</p>
			</li>
			...
			<li class="nav-item"><a class="nav-link collapsed" href="#"
				...
				aria-expanded="true" aria-controls="collapseTwo"> <i
					class="fas fa-fw fa-cog"></i> <span>사용자 정보</span>
			</a>
				<div id="collapseTwo" class="collapse" aria-labelledby="headingTwo"
					data-parent="#accordionSidebar">
					<div class="bg-white py-2 collapse-inner rounded">
						<h6 class="collapse-header">사용자 정보 관리:</h6>
						<a class="collapse-item" href="#">사용자 정보수정</a> <a
							class="collapse-item" href="#">이용내역</a> <a class="collapse-item"
							href="#">보유 포인트 확인</a>
					</div>
				</div></li>
				...
				<c:when test="${sessionScope.type eq 1}">
					<li class="nav-item"><a class="nav-link collapsed" href="#"
						...
						aria-expanded="true" aria-controls="collapseUtilities"> <i
							class="fas fa-fw fa-wrench"></i> <span>주차장관리</span>
					</a>
						<div id="collapseUtilities" class="collapse"
							...
							<div class="bg-white py-2 collapse-inner rounded">
								...
								<a class="collapse-item" href="#">주차장 정보수정</a> <a
									class="collapse-item" href="#">예약 현황</a> <a
									class="collapse-item" href="#">포인트확인</a> <a
									class="collapse-item" href="#">포인트전환</a>
							</div>
						</div></li>
				</c:when>
			</c:choose>
			...
			<li class="nav-item"><a class="nav-link collapsed" href="#"
				...
				aria-expanded="true" aria-controls="collapsePages"> <i
					class="fas fa-fw fa-folder"></i> <span>parking sharing!</span>
			</a>
				<div id="collapsePages" class="collapse"
					aria-labelledby="headingPages" data-parent="#accordionSidebar">
					<div class="bg-white py-2 collapse-inner rounded">
						<h6 class="collapse-header">sharing menu</h6>
						<a class="collapse-item" href="#">share!</a> <a
							class="collapse-item" href="#">예약현황</a> <a class="collapse-item"
							href="#">공유 내역</a>
						<div class="collapse-divider"></div>
						<h6 class="collapse-header">share 커뮤 니티:</h6>
						<a class="collapse-item" href="#">공유 주차장</a> <a
							class="collapse-item" href="#">예약 내역</a>
					</div>
				</div></li>

			<!-- Nav Item - Charts -->
			<li class="nav-item"><a class="nav-link" href="#"> <i
					class="fas fa-fw fa-chart-area"></i> <span>고객 센터</span></a></li>

			<!-- Nav Item - Tables -->
			<li class="nav-item"><a class="nav-link" href="#"> <i
					class="fas fa-fw fa-table"></i> <span>이벤트</span></a></li>
